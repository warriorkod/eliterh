...
@NgModule({
  declarations: [HeaderComponent, PossFilterDatePipe, LocationFilterPipe, LazyFilterPipe,
    TypeJobFilterPipe, PostsFilterByTypePipe, PostsFilterByTittrePipe,
    PostsFilterByTittrePipe, PostsFilterOrderByDatePipe, PostsFilterByTypePipe, SecteurFilterPipe,
    FooterComponent, RegisterComponent, LoginComponent, LoadingScreenComponent, ScrollTopComponent],
  imports: [
    CommonModule,
    FormsModule,
    ReactiveFormsModule,
